<%-- 
    Document   : borradoReserva
    Created on : 05-mar-2022, 15:13:59
    Author     : gonza
--%>
        ...
        <div id="wrapper" class="container bg-fondo2">
            ...
            <section  >
                <%
                  ...
                  s.execute("DELETE FROM reserva WHERE codReserva=" + request.getParameter("codReserva"));
                  s.close();
                %>	
                <script>document.location = "reservas.jsp";</script> 
            </section>
        </div>
    </body>
</html>